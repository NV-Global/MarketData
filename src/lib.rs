...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MarketData processing");
    
    let mut processor = MarketDataProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MarketDataProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MarketDataProcessor::new(false);
